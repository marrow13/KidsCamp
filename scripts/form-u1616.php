...
$form = array(
	'subject' => 'Бесплатная презентация',
	'heading' => 'Форма - бесплатная презентация',
...
$newAddress = array(
     ...
     'emails' => '[{"email" : "'.$_POST["Email"].'", "variables" : {"Имя" : "'.$_POST['custom_U1633'].'", "Телефон" : "'.$_POST["custom_U1628"].'"}}]'
 );
    
 $curl->post('https://api.sendpulse.com/addressbooks/405854/emails', $data=$curl->postEncode($newAddress));
