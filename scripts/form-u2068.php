...
$newAddress = array(
     ...
     'emails' => '[{"email" : "'.$_POST["Email"].'", "variables" : {"Имя" : "'.$_POST['custom_U2093'].'", "Телефон" : "'.$_POST["custom_U2088"].'"}}]'
 );
    
 $curl->post('https://api.sendpulse.com/addressbooks/405858/emails', $data=$curl->postEncode($newAddress));
