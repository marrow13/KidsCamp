...
$form = array(
	'subject' => 'Забронировать место',
	'heading' => 'Форма - забронировать место',
...
$newAddress = array(
     ...
     'emails' => '[{"email" : "'.$_POST["Email"].'", "variables" : {"Имя" : "'.$_POST['custom_U1504'].'", "Телефон" : "'.$_POST["custom_U1482"].'"}}]'
 );
    
 $curl->post('https://api.sendpulse.com/addressbooks/410822/emails', $data=$curl->postEncode($newAddress));
