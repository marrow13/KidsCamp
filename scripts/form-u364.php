...
$form = array(
	'subject' => 'Презентация_главный экран',
	'heading' => 'Форма - Презентации главный экран',
...
$newAddress = array(
 ...
 $curl->post('https://api.sendpulse.com/addressbooks/405856/emails', $data=$curl->postEncode($newAddress));
