...
$newAddress = array(
     ...
     'emails' => '[{"email" : "'.$_POST["Email"].'", "variables" : {"Имя" : "'.$_POST['custom_U1026'].'", "Телефон" : "'.$_POST["custom_U1035"].'"}}]'
 );
    
 $curl->post('https://api.sendpulse.com/addressbooks/405853/emails', $data=$curl->postEncode($newAddress));
